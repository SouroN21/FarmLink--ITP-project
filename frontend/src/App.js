...
import ProductDetailsfarmer from "./components/product/productDetails/ProductDetails";
...
import Unsuccessful from "./pages/marketplace/details/unuccessful";
      ...
      <CategoryProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/unuccessful" element={<Unsuccessful />} />
            <Route
              path="/cart"
              element={
                <MarketplaceNavbar showCategories={false}>
            ...
            />
            <Route
              path="/product-admin-overview-table"
              element={
                <Sidebar>
                  <Layout>
                    <BarChart />
